<template>
    <div class="max-w-lg mx-auto py-8">
        <BaseH1 class="text-center underline">Editar producto <span class="font-normal italic text-red-600 ">{{
        ...
        <form action="#" @submit.prevent="handleSubmit">
            ...
            <template v-else>
                ...
                <div class="py-4">
                    <BaseButton class="" :cargando="productoCarga">Editar</BaseButton>
                </div>
            </template>
        </form>
    </div>
...
import { getProductosById, EditarProducto } from "../service/productos.js";
...
export default {
    ...
    methods: {
        ...
        async handleSubmit() {
            ...
            try {
                await EditarProducto(this.producto.id, { nombre: this.producto.nombre, precio: this.producto.precio, descripcion: this.producto.descripcion });
    ...
    async mounted() {
        ...
        this.producto = await getProductosById(this.$route.params.id);// parametro de ruta
